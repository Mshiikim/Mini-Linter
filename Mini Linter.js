...
console.log('The following words are overused with counts:')
console.log(`${overusedWords[0]} ` + count1);
console.log(`${overusedWords[1]} ` + count2);
console.log(`${overusedWords[2]} ` + count3);
